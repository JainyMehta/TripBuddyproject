...
public class Handicrafts extends AppCompatActivity {
    RecyclerView rc;
    int city_id,cat_id;
    int[] img={android.R.drawable.btn_star,android.R.drawable.btn_star,android.R.drawable.btn_star,android.R.drawable.btn_star,android.R.drawable.btn_star};
